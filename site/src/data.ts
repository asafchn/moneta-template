...
export const learningSteps = [
  ...
  { name: 'Retrieve', title: 'Bring it into the next task.', text: 'The agent reads the index, forms a query, finds frontmatter matches, then walks named edges to discover connected knowledge the query missed. Only selected bodies enter context.', tag: 'Future task · selected scope', content: 'Index → query → find → walk → read\n\n“Add project pagination”\n↳ shared client + pagination contract' },
];

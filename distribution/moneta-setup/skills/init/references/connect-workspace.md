...
Organization targets use the generated runtime profile and [private runtime connection](../../../template/plugins/moneta-codex/skills/knowledge-search/references/connection.md); no per-codebase file is required. Reach this branch only for an explicitly requested local override or existing .moneta.md.

...
Use the shared analysis role's evidence and selected-area boundaries. Return to the parent for independent evaluation; do not recursively invoke session-wide `evolve` or the message hook.

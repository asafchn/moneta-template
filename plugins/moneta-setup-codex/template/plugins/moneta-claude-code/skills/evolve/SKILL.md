...
|---|---|
| Set up or connect Moneta; no learning source requested | Invoke the installed moneta-setup:init installer or standalone moneta-setup, then return its setup/activation status. |
